...
const staticRoutes = {
  ...
  "/notification": { type: "current-affairs", title: "Current Affairs" },
  "/notification.php": { type: "current-affairs", title: "Current Affairs" },
  "/notifications": { type: "current-affairs", title: "Current Affairs" },
  "/star-police-academy-current-affairs": { type: "current-affairs", title: "Current Affairs" },
  "/current-affairs": { type: "current-affairs", title: "Current Affairs" },
  ...
  "/test-batch": { type: "current-affairs", title: "Current Affairs" },
  "/test-batch.php": { type: "current-affairs", title: "Current Affairs" },
  "/test-batches": { type: "current-affairs", title: "Current Affairs" },
  "/star-police-academy-test-batches": { type: "current-affairs", title: "Current Affairs" },
