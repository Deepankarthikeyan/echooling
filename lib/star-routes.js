...
const staticRoutes = {
  ...
  "/questions": { type: "courses", title: "Question Papers" },
  "/ansewrkey": { type: "courses", title: "Answer Keys" },
  "/notification": { type: "courses", title: "Notifications" },
  "/youtube": { type: "toppers", title: "Youtube Channel" },
  "/test-batch": { type: "courses", title: "Test Batches" },
...
const knownRouteAliases = Array.from(
  new Set([
    ...
    ...Object.keys(staticRoutes).map((route) => (route === "/" ? "/index.html" : `${route}.html`)),
  ])
);
