...
const typeSeoDefaults = {
  ...
  "test-batches": {
    title:
      "Star Police Academy - TARGET காக்கிசட்டை, TNUSRB Sub Inspector Coaching, Book Back Question Books",
    useBrandSuffix: false,
    description:
      "Star Police Academy test batches, daily online tests, SPA test schedules and TNUSRB Sub Inspector intensive coaching programmes.",
    keywords:
      "Star Police Academy test batch, TNUSRB test schedule, daily online test, SI coaching test batch Tamil Nadu",
    ogImage: DEFAULT_OG_IMAGE,
  },
  youtube: {
