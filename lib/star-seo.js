...
const canonicalByType = {
  ...
  "current-affairs": "/star-police-academy-current-affairs",
  "test-batches": "/star-police-academy-test-batches",
...
const typeSeoDefaults = {
  ...
  "current-affairs": {
    title: "Current Affairs | Star Police Academy",
    useBrandSuffix: false,
    description:
      "Read daily and weekly current affairs updates for TNUSRB SI and Police Constable exams from Star Police Academy in Vellore.",
    keywords:
      "TNUSRB current affairs, police exam current affairs, SI current affairs Tamil Nadu, constable GK updates",
    ogImage: DEFAULT_OG_IMAGE,
  },
  "test-batches": {
    title: "Test Batches | Star Police Academy",
    useBrandSuffix: false,
    description:
      "View Star Police Academy test batch schedules, mock test plans, and exam preparation timetables for TNUSRB SI and Police Constable coaching.",
    keywords:
      "TNUSRB test batch, police coaching test schedule, SI mock test batch, Star Police Academy test timetable",
    ogImage: DEFAULT_OG_IMAGE,
  },
  youtube: {
  ...
  toppers: {
    ...
    ogImage: "/assets/images/gallery/gallery-classroom-session.png",
  },
};
