const { academy, contact, courses, faqs, socialLinks, testimonials } = require("./star-content");
...
const FAVICON = "/assets/images/logos/star-police-academy-logo.png";
...
const canonicalByType = {
  ...
  materials: "/materials",
  questions: "/questions",
  "answer-keys": "/ansewrkey",
  notification: "/notification",
  youtube: "/youtube",
  toppers: "/toppers",
  "si-landing": "/police-sub-inspector-coaching",
  "tnusrb-landing": "/tnusrb",
  "army-landing": "/indian-army",
  "navy-landing": "/indian-navy",
  "air-force-landing": "/indian-air-force",
  "rpf-landing": "/rpf",
  "capf-landing": "/capf",
};
...
function buildOrganizationSchema() {
  return {
    ...
    address: {
      "@type": "PostalAddress",
      streetAddress: "#85 Anandham Nagar, Sripuram, Usoor",
...
function buildSchemas(page, title, description, ogImage) {
  ...
  if (page?.type === "home" || page?.type === "contact") {
    schemas.push(buildLocalBusinessSchema(ogImage));
